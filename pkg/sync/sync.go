...
func SyncVariables() error {
	...
	inputFile := viper.GetString("GHMV_CSV_FILE")
	hostname := viper.GetString("GHMV_TARGET_HOSTNAME")
	targetOrg := viper.GetString("GHMV_TARGET_ORGANIZATION")
	targetToken := viper.GetString("GHMV_TARGET_TOKEN")
